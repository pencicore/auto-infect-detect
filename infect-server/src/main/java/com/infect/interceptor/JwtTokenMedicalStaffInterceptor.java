...
@Component
public class JwtTokenMedicalStaffInterceptor extends JwtTokenInterceptor implements HandlerInterceptor {
    ...
    private static final String[] userTypes = {
            ...
            JwtConstant.USER_TYPE_CDC_STAFF,
            JwtConstant.USER_TYPE_MEDICAL_STAFF
    };
