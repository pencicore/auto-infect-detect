...
public class EmployeeDiagnosisController {
    ...
    public Result<AllDiagnosisAndResultDTO> getReportFile(
            @ApiParam(value = "查询时间", required = true, example = "2024-08-29") @RequestBody String date) {
    ...
    // @PostMapping("/result")
    // public Result saveDiagnosisResult(@RequestBody DiagnosisResultsEmpDTO
    // diagnosisResultsEmpDTO) {
    // log.info("用户（铁路工人）{}自己提交诊断结果：{}", BaseContext.getCurrentId(),
    // diagnosisResultsEmpDTO);
    // diagnosisresultsService.saveDiagnosisResult(diagnosisResultsEmpDTO,
    // BaseContext.getCurrentId(), BaseContext.getCurrentId());
    // return Result.success();
    // }
    ...
    // diagnosisresultsService.getDiagnosisResult(date, BaseContext.getCurrentId());
    // return Result.success(diagnosisresults);
    // }

    // @ApiOperation(value = "提交个人基本情况")
    // @PostMapping("/personal")
    // public Result saveDiagnosisPersonal(@RequestBody Diagnosispersonalinfo
    // diagnosispersonalinfo) {
    // log.info("用户{}提交诊断个人基本信息表：{}", BaseContext.getCurrentId(),
    // diagnosispersonalinfo);
    // diagnosispersonalinfoService.saveDiagnosisPersonal(BaseContext.getCurrentId(),
    // diagnosispersonalinfo);
    // return Result.success();
    // }
    //
    ...
    // public Result saveGeneralSymptoms(@RequestBody Diagnosisgeneralsymptoms
    // generalSymptoms) {
    // log.info("用户{}提交诊断全身症状表：{}", BaseContext.getCurrentId(), generalSymptoms);
    // diagnosispersonalinfoService.saveDiagnosisGeneralSymptoms(BaseContext.getCurrentId(),
    // generalSymptoms);
    // return Result.success();
    // }
    //
    ...
    // public Result saveRespiratorySymptoms(@RequestBody
    // Diagnosisrespiratorysymptoms respiratorySymptoms) {
    // log.info("用户{}提交诊断呼吸系统症状表：{}", BaseContext.getCurrentId(),
    // respiratorySymptoms);
    // diagnosispersonalinfoService.saveDiagnosisRespiratorySymptoms(BaseContext.getCurrentId(),
    // respiratorySymptoms);
    // return Result.success();
    // }
    //
    ...
    // public Result saveDigestiveSymptoms(@RequestBody Diagnosisdigestivesymptoms
    // digestiveSymptoms) {
    // log.info("用户{}提交诊断消化系统症状表：{}", BaseContext.getCurrentId(),
    // digestiveSymptoms);
    // diagnosispersonalinfoService.saveDiagnosisDigestiveSymptoms(BaseContext.getCurrentId(),
    // digestiveSymptoms);
    // return Result.success();
    // }
    //
    ...
    // public Result saveCirculatorySymptoms(@RequestBody
    // Diagnosiscirculatorysymptoms circulatorySymptoms) {
    // log.info("用户{}提交诊断循环系统症状表：{}", BaseContext.getCurrentId(),
    // circulatorySymptoms);
    // diagnosispersonalinfoService.saveDiagnosisCirculatorySymptoms(BaseContext.getCurrentId(),
    // circulatorySymptoms);
    // return Result.success();
    // }
    //
    ...
    // public Result saveNeurologicalSymptoms(@RequestBody
    // Diagnosisneurologicalsymptoms neurologicalSymptoms) {
    // log.info("用户{}提交诊断神经系统症状表：{}", BaseContext.getCurrentId(),
    // neurologicalSymptoms);
    // diagnosispersonalinfoService.saveDiagnosisNeurologicalSymptoms(BaseContext.getCurrentId(),
    // neurologicalSymptoms);
    // return Result.success();
    // }
    //
    ...
    // public Result saveLocalSymptoms(@RequestBody Diagnosislocalsymptoms
    // localSymptoms) {
    // log.info("用户{}提交诊断局部症状表：{}", BaseContext.getCurrentId(), localSymptoms);
    // diagnosispersonalinfoService.saveDiagnosisLocalSymptoms(BaseContext.getCurrentId(),
    // localSymptoms);
    // return Result.success();
    // }
    //
    ...
    // public Result saveOtherSymptoms(@RequestBody Diagnosisothersymptoms
    // otherSymptoms) {
    // log.info("用户{}提交诊断其他症状表：{}", BaseContext.getCurrentId(), otherSymptoms);
    // diagnosispersonalinfoService.saveDiagnosisOtherSymptoms(BaseContext.getCurrentId(),
    // otherSymptoms);
    // return Result.success();
    // }
    //
    ...
    // public Result saveComplications(@RequestBody Diagnosiscomplications
    // complications) {
    // log.info("用户{}提交诊断并发症表：{}", BaseContext.getCurrentId(), complications);
    // diagnosispersonalinfoService.saveDiagnosisComplications(BaseContext.getCurrentId(),
    // complications);
    // return Result.success();
    // }
    // @ApiOperation("提交诊断检查项目表")
    // @PostMapping("/examinations")
    // public Result saveDiagnosisExaminations(@RequestBody Diagnosisexaminations
    // diagnosisexaminations) {
    // log.info("用户{}提交诊断检查项目表:{}", BaseContext.getCurrentId(),
    // diagnosisexaminations);
    //
    // diagnosisexaminationsService.saveDiagnosisExaminations(BaseContext.getCurrentId(),
    // diagnosisexaminations);
    // return Result.success();
    // }
    //
    ...
    // @PostMapping("report")
    // public Result saveDiagnosisReports(@RequestBody Diagnosisreports
    // diagnosisreports) {
